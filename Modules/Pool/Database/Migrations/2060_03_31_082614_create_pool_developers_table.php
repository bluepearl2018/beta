...
class CreatePoolDevelopersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pool_developers', function (Blueprint $table) {
            $table->increments('id')->index();
            $table->integer('user_id')->unsigned()->nullable()->index();
            $table->integer('pool_id')->unsigned()->nullable()->index();
            $table->integer('developer_id')->unsigned()->nullable()->index();
            ...
            $table->foreign('developer_id')->references('id')->on('users')->nullable();
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(array('developer_id', 'language_id', 'pool_id'));
        });
    }
    ...
    {
        Schema::dropIfExists('pool_developers');
    }
}
