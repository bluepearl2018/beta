...
class CreatePoolManagersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pool_managers', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(array('manager_id', 'language_id', 'pool_id'));
        });
    ...
    {
        Schema::dropIfExists('pool_managers');
    }
}
