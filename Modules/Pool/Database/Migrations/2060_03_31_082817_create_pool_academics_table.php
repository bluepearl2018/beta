...
class CreatePoolAcademicsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pool_academics', function (Blueprint $table) {
            $table->increments('id')->index();
            $table->integer('user_id')->unsigned()->nullable()->index();
            $table->integer('pool_id')->unsigned()->nullable()->index();
            $table->integer('academic_id')->unsigned()->nullable()->index();
            ...
            $table->foreign('academic_id')->references('id')->on('users')->nullable();
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(array('academic_id', 'language_id', 'pool_id'));
        });
    }
    ...
    {
        Schema::dropIfExists('pool_academics');
    }
}
