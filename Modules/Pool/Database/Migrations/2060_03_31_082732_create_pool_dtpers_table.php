...
class CreatePoolDtpersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pool_dtpers', function (Blueprint $table) {
            $table->increments('id')->index();
            $table->integer('user_id')->unsigned()->nullable()->index();
            $table->integer('pool_id')->unsigned()->nullable()->index();
            $table->integer('dtper_id')->unsigned()->nullable()->index();
            ...
            $table->foreign('dtper_id')->references('id')->on('users')->nullable();
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->unique(array('dtper_id', 'language_id', 'pool_id'));
        });
    }
    ...
    {
        Schema::dropIfExists('pool_dtpers');
    }
}
