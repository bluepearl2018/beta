...
class WelcomeServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->register(WelcomeViewServiceProvider::class);
    }
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('welcome.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'welcome'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(__DIR__ .'/../Resources/lang', 'welcome');
        }
    }
