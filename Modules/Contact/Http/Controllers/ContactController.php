...
class ContactController extends HttpController
{
    ...
    ***************************************************************/
    ...
    {
        return view('contact::partials.contact_eutranet.contact_eutranet');
    }
    ...
    ***************************************************************/
    ...
    public function getTeamMailing(?User $user)
    {
        if($user->hasRole('premium-exclusive'))
        {
            ...
            return view('contact::partials.contact_my_team.contact_my_team')->with(compact('myTeam'));
        }
        Session::push('status', 'Fonctionnalité réservée aux membres Premium Exclusive');
    ...
    public function postTeamMailing(Request $request)
    {
        ...
        $recipients = UserTeam::whereIn('user_id', $teamMembers)->get();
    ...
    ***************************************************************/
    ...
    public function getCoreMailing()
    {
        ...
        return view('contact::partials.contact_core.contact_core')->with(compact('coreTeam'));
    }
    ...
    ***************************************************************/
    ...
    {
        $this->middleware(['auth', 'verified']);
        return view('contact::partials.contact_eutranet.contact_webmaster');
    }
    ...
    ***************************************************************/
    ...
    public function contactUser(Request $request)
    {
        ...
        if($recipient && $sender){
            ...
            return view('contact::partials.contact_user.contact_user')->with(compact('recipient'));
        }
    ...
    ***************************************************************/
    ...
    public function contactPoolEutranet()
    {
        ...
        if(isset($poolCode) && !empty($poolCode) && isset($subPoolCode) && !empty($subPoolCode)){
            return view('contact::layouts.master')->with(compact('poolCode', 'subPoolCode'));
        }
    ...
    {
        $this->middleware('auth');
        return view('contact::partials.contact_pools.contact_pool_manager');
    }
