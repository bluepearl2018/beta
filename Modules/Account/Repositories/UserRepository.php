...
class UserRepository 
{
    ...
    public function getCurrentUserAccountDetails($currentUser)
    {
        $hasVAT = $this->hasVAT($currentUser);
        $userVAT = $this->getUserVAT($currentUser);
        $isActive = $this->isActive($currentUser);
        $isVisible = $this->isVisible($currentUser);
        $isFree = $this->isFree($currentUser);
        $isPremium = $this->isPremium($currentUser);
        $isPremiumExclusive = $this->isPremiumExclusive($currentUser);
        return compact('isVisible', 'isActive', 'hasVAT', 'userVAT', 'isPremium', 'isFree', 'isPremiumExclusive');
    }
    ...
    public function maxSocialmediaForUser($user){
        return \App\Models\SociaMedia::count();
    }
